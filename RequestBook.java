 ...
 class RequestBook extends JFrame implements ActionListener
{
	...
	JTable t=new JTable();
	Object[] columns={"Book ID","Category","Book Name","Email"}; 	
	...
	RequestBook() 
	{
	  ...
	  JLabel Email=new JLabel("Email:");                               //problem
	  Email.setBounds(40,400,100,30);
